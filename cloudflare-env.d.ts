/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 08eb9f8130d257b3e4c61d961ca86655)
// Runtime types generated with workerd@1.20250525.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXT_PUBLIC_SITE_URL: "real-fight.first-hono-project.workers.dev";
		NEXTJS_ENV: string;
		R2: R2Bucket;
		DB: D1Database;
		ASSETS: Fetcher;
